...
if exist %ROOTDIR%\vnd\vendor-prebuild.cmd (
   call %ROOTDIR%\vnd\vendor-prebuild.cmd %*
...
if exist %ROOTDIR%\vnd\vendor-postbuild.cmd (
   call %ROOTDIR%\vnd\vendor-postbuild.cmd %*
   if %errorlevel% neq 0 goto :failure
)
